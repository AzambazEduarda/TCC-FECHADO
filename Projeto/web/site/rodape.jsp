                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-6">
                            <div class="footer">
                                ...
                                <p>Entre em contato conosco, estamos aqui para melhor atendê-lo.</p>
                                <ul class="footer-links">
                                    <li><a href="#"><i class="fa fa-map-marker"></i>651, Luiz Adão Médici</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <span class="copyright">
                                ...
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">DUDÃO</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </span>
                        </div>
                    </div>
