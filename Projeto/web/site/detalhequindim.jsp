        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="product-details">
                    <h2 class="product-name">Quindim</h2>
                    <div>
                    ...
                    <div>
                        <h3 class="product-price">R$4.00 </h3>
                        </br>
                        <h4 class="">75g </h4>

                        <!-- <span class="product-available">Disponível em estoque</span> -->
                    </div>
                    <p>O nome quindim para os africanos significa dengo, encanto. O doce português levemente 
                        diferente do africano, originamenlte chamado "brisa-de-lis" leva amêndoas, diferente do africano
                        que tem coco ralado em sua preparação.</p>
            ...
            <div class="col-md-12">
                <div id="product-tab">
                    ...
                    <ul class="tab-nav">
                        ...
                        <li><a data-toggle="tab" href="#tab1">Comentários</a></li>
                        <li><a data-toggle="tab" href="#tab3">Ingredientes</a></li>
                    </ul>
                    <!-- /product tab nav -->
                    ...
                    <div class="tab-content">
                       ...
                       TROCAR A CLASS SE NECESSÁRIO/ TROQUEI DE NOITE PORQUE O COMENTARIO NÃO TAVA APARECENDO
                            <div class="row">
                                        ...
                                        <ul class="reviews">
                                            <li>
                                                ...
                                                <div class="review-body">
                                                    <p>Melhor doce que já comi na vidaaaaaaaa, nossaa recomendo demais.</p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="review-heading">
                                                ...
                                                <div class="review-body">
                                                    <p>Miga suaa loka, que quindim é esse!???? Coisa louca de tão bom, vou comer todooos.</p>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="review-heading">
                                                ...
                                                <div class="review-body">
                                                    <p>Não sei o gosto, Dudão tá só me enrolando. -_-</p>
                                                </div>
                                            </li>
                                        </ul>
                ...
                <div class="product">
                    ...
                    <div class="product-body">
                        ...
                        <div class="product-btns">
                            ...
                            <button class="quick-view"><i class="fa fa-eye"></i><span class="tooltipp">Detalhar</span></button>
                        </div>
                    </div>
                    <div class="add-to-cart">
                        <button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Adicionar ao Carrinho</button>
